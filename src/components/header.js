                ...
                <Row className="header-row">
                    ...
                    <Col {...MenuSizing}>
                        <Menu
                            ...
                            className="main-nav"
                        >
                            <Menu.Item key="0" className="get-quote"><Link to="/publish"><Icon type="plus-circle" theme="outlined" />Publish a Post</Link></Menu.Item>
                            ...
                            <Menu.Item key="1"><Link to="/help"><Icon type="question-circle" theme="outlined" />Help</Link></Menu.Item>
                            </Menu>
                    </Col>
